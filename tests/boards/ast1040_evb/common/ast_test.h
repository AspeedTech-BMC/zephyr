 ...
 *
 * Board-agnostic; copied verbatim from tests/boards/ast1030_evb/common/
 * ast_test.h (itself ported near-verbatim from aspeed-dev-v2.6.0's
 * tests/boards/ast1030/src/ast_test.h). Kept as the shared assertion style
 * for every peripheral under tests/boards/ast1040_evb/ because, unlike
 * zassert_*, it just sets a flag and prints instead of longjmp'ing - safe to
 * call from any thread, which is required by the concurrent runner in
 * tests/boards/ast1040_evb/all/.
 */
