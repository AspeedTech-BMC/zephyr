...
FUN_DEFINE(DT_NODELABEL(pinctrl_smbflt_default), SMBF1SCLIN, SMBF1SDAIN, SMBF1SCLOUT, SMBF1SDAOUT,
SMBF2SCLIN, SMBF2SDAIN, SMBF2SCLOUT, SMBF2SDAOUT, SMBF3SCLIN, SMBF3SDAIN, SMBF3SCLOUT, SMBF3SDAOUT,
SMBF4SCLIN, SMBF4SDAIN, SMBF4SCLOUT, SMBF4SDAOUT)
#endif
...
FUN_DEFINE(DT_NODELABEL(pinctrl_spim1_default), SPIM1CSIN, SPIM1CLKIN, SPIM1MOSIIN, SPIM1MISOIN,
	SPIM1IO2IN, SPIM1IO3IN, SPIM1CSOUT, SPIM1CLKOUT, SPIM1MOSIOUT, SPIM1MISOOUT, SPIM1IO2OUT,
	SPIM1IO3OUT, SPIM1MUXSEL, SPIM1SPIRSTOUT, SPIM1SPIRSTIN)
#endif

#if DT_NODE_HAS_STATUS(DT_NODELABEL(spim2), okay) && CONFIG_SPI_MONITOR_ASPEED
FUN_DEFINE(DT_NODELABEL(pinctrl_spim2_default), SPIM2CSIN, SPIM2CLKIN, SPIM2MOSIIN, SPIM2MISOIN,
	SPIM2IO2IN, SPIM2IO3IN, SPIM2CSOUT, SPIM2CLKOUT, SPIM2MOSIOUT, SPIM2MISOOUT, SPIM2IO2OUT,
	SPIM2IO3OUT, SPIM2MUXSEL, SPIM2SPIRSTOUT, SPIM2SPIRSTIN)
#endif

#if DT_NODE_HAS_STATUS(DT_NODELABEL(spim3), okay) && CONFIG_SPI_MONITOR_ASPEED
FUN_DEFINE(DT_NODELABEL(pinctrl_spim3_default), SPIM3CSIN, SPIM3CLKIN, SPIM3MOSIIN, SPIM3MISOIN,
	SPIM3IO2IN, SPIM3IO3IN, SPIM3CSOUT, SPIM3CLKOUT, SPIM3MOSIOUT, SPIM3MISOOUT, SPIM3IO2OUT,
	SPIM3IO3OUT, SPIM3MUXSEL, SPIM3SPIRSTOUT, SPIM3SPIRSTIN)
#endif

#if DT_NODE_HAS_STATUS(DT_NODELABEL(spim4), okay) && CONFIG_SPI_MONITOR_ASPEED
FUN_DEFINE(DT_NODELABEL(pinctrl_spim4_default), SPIM4CSIN, SPIM4CLKIN, SPIM4MOSIIN, SPIM4MISOIN,
	SPIM4IO2IN, SPIM4IO3IN, SPIM4CSOUT, SPIM4CLKOUT, SPIM4MOSIOUT, SPIM4MISOOUT, SPIM4IO2OUT,
	SPIM4IO3OUT, SPIM4MUXSEL, SPIM4SPIRSTOUT, SPIM4SPIRSTIN)
#endif
