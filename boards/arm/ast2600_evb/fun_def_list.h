...
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm8g0_default), PWM8G0)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm9g0_default), PWM9G0)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm10g0_default), PWM10G0)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm11g0_default), PWM11G0)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm12g0_default), PWM12G0)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm13g0_default), PWM13G0)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm14g0_default), PWM14G0)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm15g0_default), PWM15G0)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm8g1_default), PWM8G1)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm9g1_default), PWM9G1)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm10g1_default), PWM10G1)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm11g1_default), PWM11G1)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm12g1_default), PWM12G1)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm13g1_default), PWM13G1)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm14g1_default), PWM14G1)
FUN_DEFINE(DT_NODELABEL(pinctrl_pwm15g1_default), PWM15G1)
#endif
