...
SIG_DEFINE(PWM8G0, AB22, SIG_DESC_SET(0x41C, 24))
SIG_DEFINE(PWM8G1,  D22, SIG_DESC_CLEAR(0x414, 8),  SIG_DESC_SET(0x4B4, 8))
SIG_DEFINE(PWM9G0, W24, SIG_DESC_SET(0x41C, 25))
SIG_DEFINE(PWM9G1,  E22, SIG_DESC_CLEAR(0x414, 9),  SIG_DESC_SET(0x4B4, 9))
SIG_DEFINE(PWM10G0, AA23, SIG_DESC_SET(0x41C, 26))
SIG_DEFINE(PWM10G1, D23, SIG_DESC_CLEAR(0x414, 10), SIG_DESC_SET(0x4B4, 10))
SIG_DEFINE(PWM11G0, AA24, SIG_DESC_SET(0x41C, 27))
SIG_DEFINE(PWM11G1, C23, SIG_DESC_CLEAR(0x414, 11), SIG_DESC_SET(0x4B4, 11))
SIG_DEFINE(PWM12G0, W23, SIG_DESC_SET(0x41C, 28))
SIG_DEFINE(PWM12G1, C22, SIG_DESC_CLEAR(0x414, 12), SIG_DESC_SET(0x4B4, 12))
SIG_DEFINE(PWM13G0, AB23, SIG_DESC_SET(0x41C, 29))
SIG_DEFINE(PWM13G1, A25, SIG_DESC_CLEAR(0x414, 13), SIG_DESC_SET(0x4B4, 13))
SIG_DEFINE(PWM14G0, AB24, SIG_DESC_SET(0x41C, 30))
SIG_DEFINE(PWM14G1, A24, SIG_DESC_CLEAR(0x414, 14), SIG_DESC_SET(0x4B4, 14))
SIG_DEFINE(PWM15G0, Y23, SIG_DESC_SET(0x41C, 31))
SIG_DEFINE(PWM15G1, A23, SIG_DESC_CLEAR(0x414, 15), SIG_DESC_SET(0x4B4, 15))
#endif
...
SIG_DEFINE(I3C3SCL, AF25, SIG_DESC_SET(0x438, 20), SIG_DESC_CLEAR(0x418, 8))
SIG_DEFINE(I3C3SDA, AE26, SIG_DESC_SET(0x438, 21), SIG_DESC_CLEAR(0x418, 9))
SIG_DEFINE(HVI3C3SCL, B20, SIG_DESC_SET(0x418, 8), SIG_DESC_CLEAR(0x4B8, 8),
	   SIG_DESC_CLEAR(0x438, 20))
SIG_DEFINE(HVI3C3SDA, A20, SIG_DESC_SET(0x418, 9), SIG_DESC_CLEAR(0x4B8, 9),
	   SIG_DESC_CLEAR(0x438, 21))
#endif

#if DT_NODE_HAS_STATUS(DT_NODELABEL(i3c3), okay)
SIG_DEFINE(I3C4SCL, AE25, SIG_DESC_SET(0x438, 22), SIG_DESC_CLEAR(0x418, 10))
SIG_DEFINE(I3C4SDA, AF24, SIG_DESC_SET(0x438, 23), SIG_DESC_CLEAR(0x418, 11))
SIG_DEFINE(HVI3C4SCL, E19, SIG_DESC_SET(0x418, 10), SIG_DESC_CLEAR(0x4B8, 10),
	   SIG_DESC_CLEAR(0x438, 22))
SIG_DEFINE(HVI3C4SDA, D20, SIG_DESC_SET(0x418, 11), SIG_DESC_CLEAR(0x4B8, 11),
	   SIG_DESC_CLEAR(0x438, 23))
#endif
