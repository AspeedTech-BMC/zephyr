...
#define MPU_ID_I3C		(0x4008)
#define MPU_ID_MAC0		(0x4009)
#define MPU_ID_MAC1		(0x400A)
#define MPU_ID_MAC2		(0x400B)
#define MPU_ID_FSI		(0x400C)
#define MPU_ID_MCTP1		(0x400D)
#define MPU_ID_LTPI0		(0x400E)
#define MPU_ID_XDMA1		(0x400F)
#define MPU_ID_USB2_PORT_A	(0x4010)
#define MPU_ID_USB2_PORT_B	(0x4011)
#define MPU_ID_LTPI1		(0x4012)
