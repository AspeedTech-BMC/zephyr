 ...
 */
#ifndef ZEPHYR_INCLUDE_DRIVERS_I2C_TARGET_IPMB_H_
#define ZEPHYR_INCLUDE_DRIVERS_I2C_TARGET_IPMB_H_
...
/**
 * @brief I2C IPMB Target Driver API
 * @defgroup i2c_ipmb_target_api i2c IPMB target driver API
...
#endif /* ZEPHYR_INCLUDE_DRIVERS_I2C_TARGET_IPMB_H_ */
