 ...
 */
typedef int (*jtag_api_tap_get)(const struct device *dev, enum tap_state *state);
 ...
 */
typedef int (*jtag_api_sw_xfer)(const struct device *dev, enum jtag_pin pin, uint8_t value);
...
{
	const struct jtag_driver_api *api = (const struct jtag_driver_api *)dev->api;
...
static inline int z_impl_jtag_tap_get(const struct device *dev, enum tap_state *state)
{
	const struct jtag_driver_api *api = (const struct jtag_driver_api *)dev->api;
...
static inline int z_impl_jtag_tap_set(const struct device *dev, enum tap_state state)
{
	const struct jtag_driver_api *api = (const struct jtag_driver_api *)dev->api;
...
static inline int z_impl_jtag_tck_run(const struct device *dev, uint32_t run_count)
{
	const struct jtag_driver_api *api = (const struct jtag_driver_api *)dev->api;
...
__syscall int jtag_ir_scan(const struct device *dev, int num_bits, const uint8_t *out_value,
...
__syscall int jtag_dr_scan(const struct device *dev, int num_bits, const uint8_t *out_value,
			   uint8_t *in_value, enum tap_state state);
...
__syscall int jtag_sw_xfer(const struct device *dev, enum jtag_pin pin, uint8_t value);

static inline int z_impl_jtag_sw_xfer(const struct device *dev, enum jtag_pin pin, uint8_t value)
{
	const struct jtag_driver_api *api = (const struct jtag_driver_api *)dev->api;
