...
#define IPC_CHANNEL_0_BOOTMCU_IN_ADDR		(0x70006000)
#define IPC_CHANNEL_0_BOOTMCU_OUT_ADDR		(0x70004000)
#define IPC_CHANNEL_ID_CPTRA			1
#define IPC_CHANNEL_1_SSP_IN_ADDR		(0x70007000)
#define IPC_CHANNEL_1_SSP_OUT_ADDR		(0x70005000)
#define IPC_CHANNEL_1_BOOTMCU_IN_ADDR		(0x70007000)
#define IPC_CHANNEL_1_BOOTMCU_OUT_ADDR		(0x70005000)
