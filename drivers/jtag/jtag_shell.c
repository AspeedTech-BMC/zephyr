...
SHELL_SUBCMD_DICT_SET_CREATE(sub_tap_cmds, cmd_tap_state, (DREXIT2, TAP_DREXIT2, "DREXIT2"),
			     (DREXIT1, TAP_DREXIT1, "DREXIT1"), (DRSHIFT, TAP_DRSHIFT, "DRSHIFT"),
			     (DRPAUSE, TAP_DRPAUSE, "DRPAUSE"),
			     (IRSELECT, TAP_IRSELECT, "IRSELECT"),
			     (DRUPDATE, TAP_DRUPDATE, "DRUPDATE"),
			     (DRCAPTURE, TAP_DRCAPTURE, "DRCAPTURE"),
			     (DRSELECT, TAP_DRSELECT, "DRSELECT"),
			     (IREXIT2, TAP_IREXIT2, "IREXIT2"), (IREXIT1, TAP_IREXIT1, "IREXIT1"),
			     (IRSHIFT, TAP_IRSHIFT, "IRSHIFT"), (IRPAUSE, TAP_IRPAUSE, "IRPAUSE"),
			     (IDLE, TAP_IDLE, "IDLE"), (IRUPDATE, TAP_IRUPDATE, "IRUPDATE"),
			     (IRCAPTURE, TAP_IRCAPTURE, "IRCAPTURE"), (RESET, TAP_RESET, "RESET"));

SHELL_SUBCMD_DICT_SET_CREATE(sub_pin_cmds, cmd_sw_xfer, (TDI, JTAG_TDI, "TDI"),
			     (TCK, JTAG_TCK, "TCK"), (TMS, JTAG_TMS, "TMS"),
			     (TRST, JTAG_TRST, "TRST"));

SHELL_STATIC_SUBCMD_SET_CREATE(sub_action_cmds, SHELL_CMD(high, &sub_pin_cmds, "<pin>", NULL),
			       SHELL_CMD(low, &sub_pin_cmds, "<pin>", NULL), SHELL_SUBCMD_SET_END);

SHELL_STATIC_SUBCMD_SET_CREATE(sub_jtag_cmds,
			       SHELL_CMD_ARG(frequency, NULL, "<frequency>", cmd_frequency, 2, 0),
			       SHELL_CMD_ARG(tck_run, NULL, "<run_count>", cmd_tck_run, 2, 0),
			       SHELL_CMD_ARG(ir_scan, NULL, "<len> <value>", cmd_ir_scan, 3, 0),
			       SHELL_CMD_ARG(dr_scan, NULL, "<len> <value>", cmd_dr_scan, 3, 0),
