...
#define CMD_HELP_INIT "<device> <kbps>"
#define CMD_HELP_PING "<device> <addr>"
#define CMD_HELP_GETDIB "<device> <addr>"
#define CMD_HELP_GETTEMP "<device> <addr>"
#define CMD_HELP_RAW "<device> <addr> <wr_len> <rd_len> <command(hex)> <...>"

SHELL_STATIC_SUBCMD_SET_CREATE(peci_cmds, SHELL_CMD_ARG(init, NULL, CMD_HELP_INIT, cmd_init, 3, 0),
			       SHELL_CMD_ARG(ping, NULL, CMD_HELP_PING, cmd_ping, 3, 0),
			       SHELL_CMD_ARG(getdib, NULL, CMD_HELP_GETDIB, cmd_getdib, 3, 0),
			       SHELL_CMD_ARG(gettemp, NULL, CMD_HELP_GETTEMP, cmd_gettemp, 3, 0),
			       SHELL_CMD_ARG(raw, NULL, CMD_HELP_RAW, cmd_raw, 6, 64),
