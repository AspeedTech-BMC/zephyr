...
union timing_negotiation_register_t {
	volatile uint32_t value;
	struct {
...
union command_register_t {
	volatile uint32_t value;
	struct {
		volatile uint32_t fire_a_peci_command : 1;      /*[0-0]*/
		volatile uint32_t reserved0: 23;                         /*[1-23]*/
		volatile uint32_t peci_controller_state : 4;    /*[24-27]*/
		volatile uint32_t reserved1: 2;                          /*[28-29]*/
...
union read_write_length_register_t {
	volatile uint32_t value;
	struct {
		...
		volatile uint32_t reserved0: 7;                          /*[24-30]*/
		volatile uint32_t enable_aw_fcs_cycle : 1;      /*[31-31]*/

	} fields;
}; /* 0x0000000c */

union expected_fcs_data_register_t {
	volatile uint32_t value;
	struct {
...
union captured_fcs_data_register_t {
	volatile uint32_t value;
	struct {
...
union interrupt_status_register_t {
	...
	struct {
		...
		volatile uint32_t reserved0: 10;                                         /*[5-14]*/
		volatile uint32_t good1fcs_status : 1;                          /*[15-15]*/
		volatile uint32_t timing_negotiation_result_bit_13_0 : 14;      /*[16-29]*/
		volatile uint32_t reserved1: 2;                                          /*[30-31]*/

	} fields;
}; /* 0x0000001c */

union write_data_register_t {
	volatile uint32_t value;
	volatile uint8_t data[4];
};

union read_data_register_t {
	volatile uint32_t value;
	volatile uint8_t data[4];
};

struct peci_register_t {
	union control_register_t control;                             /* 0x00000000 */
	union timing_negotiation_register_t timing_negotiation;       /* 0x00000004 */
	union command_register_t command;                             /* 0x00000008 */
	union read_write_length_register_t peci_header;               /* 0x0000000c */
	union expected_fcs_data_register_t expected_fcs_data;         /* 0x00000010 */
	union captured_fcs_data_register_t captured_fcs_data;         /* 0x00000014 */
	union interrupt_register_t interrupt;                         /* 0x00000018 */
	union interrupt_status_register_t interrupt_status;           /* 0x0000001c */
	union write_data_register_t write_data_32_mode_low[4];
	union read_data_register_t read_data_32_mode_low[4];
	union write_data_register_t write_data_32_mode_up[4];
	union read_data_register_t read_data_32_mode_up[4];
	uint32_t reserved0[8]; /* 00000060~0000007c*/
	union write_data_register_t write_data_64_mode[16];
	union read_data_register_t read_data_64_mode[16];
};
